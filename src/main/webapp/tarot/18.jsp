...
<html>
    ...
    <body style="background-color: black">
        <div id="layout">
            ...
            <div id="main">
                <div class="header">
                    <h1 style="color: white">月亮</h1>
                </div>
                <table>
                    <td valign="top"><p/>

                        <p align="center" style="margin-top: 0; margin-bottom: 0">
                            <IMG src="../tarot/img/144_18.jpg"></p>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p style="line-height: 200%; margin-top: 0;margin-left: 100px; margin-right: 100px; margin-bottom: 0"><b><span class="style6">
                                ...
                                ——莎士比亞《暴風雨》第五幕第一場
                                太陽闔上了警醒的眼睛，白晝投射於世界的嚴酷粗礪被抹勻、塗消了。月亮升起，高掛在她的領地上空，窺視這半邊世界開始潛動的生靈。
                                在那柔軟的銀浪中，蘑菇精靈圈閃閃發光。隨著時間流逝，暮色四合，蘑菇變得越來越亮，以自身的燐光為精靈女王照亮道路。
                                「她往這兒來了！」風中的妖精呼喊著，聲音如此曼妙，令凡人聞之渴慕發狂。「讓路！讓路！」燐火飛快地穿梭林間，閃爍發光，
                                挑逗過往的旅人，引誘他們走上歧路。不過今天並沒有人類玩具可供捕捉。樹精們從灰色的樺樹間現身，手牽著手，抖落葉片，
                                輕盈的走上前來，為冉冉而來的女王擔任侍從。當精靈女王淩虛滑步，穿過森林，銀蓮花在她赤裸的腳上躍動著。她微微一笑，翩然起舞。
                                讓路！讓路！
                                夜晚在掌權；
                                引領這舞蹈，驅離那白晝！
                                以瘋狂的歡愉，來聽我們歌唱；
                    ...
                    <tr>
                        <td>
                            <p style="line-height: 200%; margin-top: 0;margin-left: 100px; margin-right: 100px; margin-bottom: 0"><b><span class="style6">
                                ...
                                恣意妄行的旅人很容易被燐火誘惑，走上歧路，在森林裡迷路；但若能保持心中一點靈明，對日照的現實邊境之外的一瞥，
                                將會是最稀有的榮寵，最激勵人心的魔法。它是通往秘密未知的門徑，從中滲流出黑暗與光明交融的源泉，那就是「月亮」的贈禮。
                            </font></td>
                    </tr>
